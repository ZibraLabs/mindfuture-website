<template>
    <section class="w-full">
        <div class="relative w-full h-[80vh]">
            ...
            <iframe src="https://mindfuture-com-cube-animation.vercel.app/" class="w-full h-[80vh] border-none"></iframe>
        </div>
    </section>
</template>
...
<script lang="ts">
    import { World } from 'svelte2vue-test';
    import toVue from 'svelte-adapter/vue';

    export default {
        components: {
            Boxes: toVue(World, {}, "div")
        }
    }
</script> -->